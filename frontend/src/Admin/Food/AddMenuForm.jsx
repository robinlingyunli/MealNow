      ...
      <div className="px-5 lg:px-32 py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            ...
            <TextField fullWidth id="price" name="price" label="Price" variant="outlined" type="number"
            ...
            <div className="grid grid-cols-3 gap-4">
              <FormControl fullWidth variant="outlined">
                ...
                <Select id="category" name="category" label="Food Category"
                  onChange={formik.handleChange} value={formik.values.category}>
                  {restaurant.categories.length === 0
                    ? <MenuItem disabled value="">⚠️ Please create a Food Category first</MenuItem>
              ...
              <FormControl fullWidth variant="outlined">
                ...
                <Select id="vegetarian" name="vegetarian" label="Is Vegetarian"
                  onChange={formik.handleChange} value={formik.values.vegetarian}>
              ...
              <FormControl fullWidth variant="outlined">
                ...
                <Select id="seasonal" name="seasonal" label="Is Seasonal"
                  onChange={formik.handleChange} value={formik.values.seasonal}>
                  <MenuItem value={true}>Yes</MenuItem>
                  <MenuItem value={false}>No</MenuItem>
                </Select>
              </FormControl>
